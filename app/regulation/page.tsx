  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-7xl px-4 py-16">
        ...
        {/* States */}
        {loading && (
          <p className="text-sm text-slate-400">Loading regulatory items...</p>
        )}
        {error && !loading && (
        ...
        {/* Table */}
        {!loading && !error && items.length > 0 && (
          <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-800 bg-slate-900/40 shadow-sm">
                ...
                {items.map((r) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 align-top text-slate-400 text-xs">
                      {r.reference_code && (
                        <div className="font-mono text-slate-500">{r.reference_code}</div>
                      )}
